...
export const saveBlobToLocalFileSystem = (blob, fileName ) => {
 ...
 * @param timer 
 */
export const createMIDIFileFromAudioEventRecording = async (recording:RecorderAudioEvent, timer:Timer ) => {
    const BPM = timer.BPM
    ...
    data.forEach(command => {
        ...
        {
            case NOTE_ON :
                console.log("Adding event to MIDI Track" )
                track.addNote({
