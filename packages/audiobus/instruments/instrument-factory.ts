...
export class InstrumentFactory {
	...
	static async createInstrument(
		...
		switch (instrumentId) {
			...
			case INSTRUMENT_TYPE_OPENDAW_PLAYFIELD:
			case INSTRUMENT_TYPE_OPENDAW_NANO:
			case INSTRUMENT_TYPE_OPENDAW_TAPE:
			case INSTRUMENT_TYPE_OPENDAW_SOUNDFONT:
			case INSTRUMENT_TYPE_OPENDAW_VAPORISATEUR:
